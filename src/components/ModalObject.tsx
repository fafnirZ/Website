...
import { Modal, Typography, useMediaQuery, useTheme, Box, Link } from '@material-ui/core';
          ...
          >
            {
              ...
              <Link href={info.github}>
                <svg width="30" height="30" focusable="false" viewBox="0 0 12 12" fill="white">
            ...
            }
            {
              (loaded && info.link) && (
                <>
                <Typography variant="body1" color="secondary">Live Site: </Typography>
                <Link href={info.link}>
